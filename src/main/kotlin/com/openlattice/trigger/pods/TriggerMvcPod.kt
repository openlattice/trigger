package com.openlattice.trigger.pods

import com.fasterxml.jackson.databind.ObjectMapper
import com.openlattice.data.DataApi
import com.openlattice.shuttle.pods.TriggerSecurityPod
import com.openlattice.trigger.TriggerControllers
...
@Configuration
@ComponentScan(
        basePackageClasses = [TriggerControllers::class],
...
class TriggerMvcPod : WebMvcConfigurationSupport() {
    @Inject
    private lateinit var defaultObjectMapper: ObjectMapper

    @Inject
    private lateinit var shuttleSecurityPod: TriggerSecurityPod
